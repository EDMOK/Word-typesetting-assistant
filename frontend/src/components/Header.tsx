      ...
      <nav className="nav-pill">
        <div className="flex items-center justify-between h-full px-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="group p-2.5 rounded-full bg-slate-100 dark:bg-slate-800 text-amber-600 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-900/30 hover:scale-105 active:scale-95 transition-all duration-200">
